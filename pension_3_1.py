...
#script de prueba
#print(calcular_edad(datetime.datetime(2020,5,24)))
#booleano = calificaParaLaPension("MUJER",11, 10, "casa", -1, -1)
#print(booleano)
booleano = calificaParaLaPension("MUJER",11, 10, 2000, 400, 7)
print(booleano)
#print(booleano)
